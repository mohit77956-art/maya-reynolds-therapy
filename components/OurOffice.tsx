    ...
    <section id="office" className="py-16 md:py-24 bg-surface">
      <div className="max-w-content mx-auto px-6 md:px-10">
        ...
        <div className="grid md:grid-cols-5 gap-5 md:gap-6 mb-10">
          <div className="relative md:col-span-3 aspect-[4/3] overflow-hidden rounded-card">
            <Image
          ...
          <div className="relative md:col-span-2 aspect-[4/3] overflow-hidden rounded-card">
            <Image
